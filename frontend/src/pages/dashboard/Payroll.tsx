    ...
    return (
        <div className="p-6 md:p-8 space-y-8 animate-in fade-in duration-500 pb-20">
            ...
            <Card className="border-border/50 shadow-lg">
                <CardHeader>
                    <CardTitle>Barber Payroll Summary</CardTitle>
                    <CardDescription>
                            ...
                            <table className="w-full text-sm text-left min-w-[800px]">
                                ...
                                <tbody className="divide-y divide-border bg-card">
                                    {payrollData.map((barber) => (
                                        <tr key={barber.barberId} className="hover:bg-primary/5 transition-colors group">
                                            <td className="p-4 pl-6 font-bold">{barber.barberName}</td>
                                            ...
                                            <td className="p-4 text-center">
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${barber.commissionType === 'percentage'
                                            ...
                                            <td className="p-4 text-right font-bold text-primary font-mono text-base">
                                ...
                                <tfoot className="bg-primary/10 border-t-2 border-primary/30">
                                    <tr>
                                        <td className="p-4 pl-6 font-bold uppercase text-sm">Total</td>
                                        ...
                                        <td className="p-4"></td>
                                        <td className="p-4"></td>
                                        <td className="p-4 text-right font-bold text-primary font-mono text-lg">
                                            IDR {totalCommissions.toLocaleString('id-ID')}
                                        </td>
                                    </tr>
                                </tfoot>
